...
#[doc(hidden)]
#[no_mangle]
pub unsafe extern "C" fn tcs_init(secondary: bool) {
...
pub(super) fn exit_with_code(code: isize) -> ! {
    if code != 0 {
        if let Some(mut out) = panic::panic_output() {
...
#[unstable(feature = "perma_unstable", issue = "0")]
#[doc(hidden)]
// These functions are called from the entry code. They need to be pub at
// the crate level for rustc to give the symbols the right visibility for
// linking. See https://github.com/rust-lang/rfcs/issues/2165
pub mod asm_exports {
    #[unstable(feature = "perma_unstable", issue = "0")]
    pub use super::tcs_init;
    #[unstable(feature = "perma_unstable", issue = "0")]
    pub use super::entry;
    #[unstable(feature = "perma_unstable", issue = "0")]
    pub use super::panic::panic_msg;
}
